...
public class Adoptante extends Persona {
    ...
    public Adoptante(int id_persona, String nombre, int telefono, String direccion, String correo,String fecha, String observaciones ) {
    ...
    public String mostrarRol() {
        String texto= String.format("Rol: Adoptante");
        return texto;
    }
}
